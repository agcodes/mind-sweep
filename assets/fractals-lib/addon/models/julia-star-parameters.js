...
export default class JuliaStarParameters extends FractalParameters {
    ...
    setParameters(data) {
        if (data) {
            ...
            if (typeof data.c1 === 'object') {
                this.c1 = new Complex(data.c1.r, data.c1.i);
            }
            else {
            ...
            if (typeof data.c2 === 'object') {
                this.altC2_3 = true;
                this.c2 = new Complex(data.c2.r, data.c2.i);
                if (typeof data.c3 === 'object') {
                    this.altC2_3 = true;
                    this.c3 = new Complex(data.c3.r, data.c3.i);
                }
                if (typeof data.c4 === 'object') {
                    this.altC2_3_4 = true;
                    this.c4 = new Complex(data.c4.r, data.c4.i);
                }
            }
    ...
    setComplexes() {
       // this.c1 = new Complex(this.c1r, this.c1i);
        
       // this.c3 = new Complex(this.c3r, this.c3i);
        this.cP = new Complex(this.p, this.p);
    }
