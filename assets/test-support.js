  ...
  */
  {
    ...
    "moduleName": "/home/ag/dev/mind-sweep/host-app/@ember/test-helpers/setup-rendering-context.js",
    "isStrictMode": false
  });
...
define("ember-asset-loader/test-support/preload-assets", ["exports", "ember", "ember-asset-loader/services/asset-loader"], function (_exports, _ember, _assetLoader) {
  "use strict";
...
define("ember-engines/test-support/engine-resolver-for", ["exports", "ember-resolver", "@ember/debug"], function (_exports, _emberResolver, _debug) {
  "use strict";
  ...
  function engineResolverFor(engineName, modulePrefix = engineName, podModulePrefix = undefined) {
    (true && !(false) && (0, _debug.deprecate)("Use of `engineResolverFor` has been deprecated. Instead use `setupEngine(hooks, 'engine-name')` imported from `ember-engines/test-support` to load the engine you need.", false, {
...
define("ember-engines/test-support/index", ["exports", "@ember/test-helpers", "@ember/destroyable"], function (_exports, _testHelpers, _destroyable) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.loadEngine = loadEngine;
  _exports.setupEngine = setupEngine;
  /* global require */
  ...
  function setupEngine(hooks, engineName) {
  ...
  async function buildEngineOwner(owner, engineName) {
    ...
    if (ownerHasEngine(owner, engineName)) {
      ...
      (0, _destroyable.associateDestroyableChild)(owner, engineInstance);
...
define("ember-intl/test-support/-private/on-missing-translation", ["exports"], function (_exports) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.onMissingTranslation = onMissingTranslation;
  0; //eaimeta@70e063a35619d71feaimeta@70e063a35619d71f
   ...
   * @hide
   */
  function onMissingTranslation(key, _locales, options) {
    return `t:${key}:${stringifyOptions(options)}`;
  }
});
define("ember-intl/test-support/add-translations", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.addTranslations = addTranslations;
...
define("ember-intl/test-support/index", ["exports", "ember-intl/test-support/add-translations", "ember-intl/test-support/set-locale", "ember-intl/test-support/setup-intl", "ember-intl/test-support/t"], function (_exports, _addTranslations, _setLocale, _setupIntl, _t) {
  "use strict";
  ...
  Object.defineProperty(_exports, "addTranslations", {
    enumerable: true,
    get: function () {
      return _addTranslations.addTranslations;
    }
  });
  Object.defineProperty(_exports, "setLocale", {
    enumerable: true,
    get: function () {
      return _setLocale.setLocale;
    }
  });
  Object.defineProperty(_exports, "setupIntl", {
    enumerable: true,
    get: function () {
      return _setupIntl.setupIntl;
    }
  });
  ...
  0; //eaimeta@70e063a35619d71f0,"ember-intl/test-support/add-translations",0,"ember-intl/test-support/set-locale",0,"ember-intl/test-support/setup-intl",0,"ember-intl/test-support/t"eaimeta@70e063a35619d71f
});
define("ember-intl/test-support/set-locale", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";
...
define("ember-intl/test-support/setup-intl", ["exports", "@ember/test-helpers", "ember-intl/test-support/-private/on-missing-translation", "ember-intl/test-support/add-translations"], function (_exports, _testHelpers, _onMissingTranslation, _addTranslations) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.setupIntl = setupIntl;
  0; //eaimeta@70e063a35619d71f0,"@ember/test-helpers",0,"ember-intl/test-support/-private/on-missing-translation",0,"ember-intl/test-support/add-translations"eaimeta@70e063a35619d71f
  /**
  ...
  function setupIntl(hooks, locale, translations) {
    hooks.beforeEach(async function () {
      ...
      const intl = owner.lookup('service:intl');
      intl.setLocale(locale);
      intl.setOnMissingTranslation(_onMissingTranslation.onMissingTranslation);
      if (translations) {
        (0, _addTranslations.addTranslations)(locale, translations);
      }
      await (0, _testHelpers.settled)();
    });
  }
});
define("ember-intl/test-support/t", ["exports", "@ember/test-helpers"], function (_exports, _testHelpers) {
  "use strict";
